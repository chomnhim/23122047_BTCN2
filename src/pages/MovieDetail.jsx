...
export default function MovieDetail() {
  ...
  useEffect(() => {
    fetch(`/api/api/movies/${id}`, {
      ...
      .then(r => r.ok ? r.json() : Promise.reject(r.status === 401 ? 'Token expired' : 'Error'))
